...
Active todos grouped by dependency chains, organized into 3 tiers.
...
## Grand total — **227K** (was 235K)

---

## Tier 0 — Completed

- ✓ [set-last-loaded-timestamp](set-last-loaded-timestamp.md) — **8K (Haiku)** — Tracked last load time for sets
...
**Set loading** — **15K**
1. [recent-sets-on-input](recent-sets-on-input.md) — **15K (Haiku)** ← next available
